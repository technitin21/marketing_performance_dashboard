...
# Add missing columns and ensure all datasets have same columns
required_columns = ['date', 'campaign_name', 'impressions', 'clicks', 'conversions', 'spend', 'platform']

# Add missing columns to sfmc
for col in required_columns:
    if col not in sfmc.columns:
        sfmc[col] = 0  # Dummy value for missing columns
